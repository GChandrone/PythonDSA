...
# Token
openai.api_key = "Salvo no bloco de notas na pasta documentos chamada API openai"
...
def gera_texto(texto):
    ...
    response = openai.Completion.create(
        ...
        # Modelo usado
        # Outros estão disponíveis em https://platform.openai.com/account/rate-limits
        engine = "text-davinci-003"
    
        # Texto inicial da conversa com o chatbot
        prompt = texto,
        
        # Comprimento da resposta gerado pelo modelo
        max_tokens = 150,
        ...
        # Uma medida de aletoriedade de um texto gerado pelo modelo. Seu valor está entre 0 e 1.
...
def main():
         ...
         print("\nBem-vindo ao GPT-4 Chatbot do Projeto 4 do Curso Gratuito da Data Science Academy!")
         print("\www.datascienceacademy.com.br")
         print("\n(Digite 'sair' a qualquer momento para escrever o chat)")
# Loop
while True:
    ...
    # Se a mensagem digitada pelo usuário na variável Python chamada gpt4_prompt.
